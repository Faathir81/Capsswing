...
use Carbon\Carbon;
use Illuminate\Support\Facades\Log;  // Import untuk Log
use Illuminate\Support\Facades\URL;  // Import untuk URL
...
if (! function_exists('formatDate')) {
    ...
    {
        return \Carbon\Carbon::parse($date)->format('d/m/Y');  // Format sesuai kebutuhan
    }
}
